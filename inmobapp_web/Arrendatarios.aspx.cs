...
{
    public partial class Arrendatarios : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            try
            {
                ...
                string sql = "select * from tb_arrendatario";
        ...
        private void getTipoIdentificacion()
        {
            ...
            ddlTipo.DataSource = ds.Tables["TipoIdentificacion"].DefaultView;
        ...
        protected void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection sqlCon = new SqlConnection(conn))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    //
                    cmd.CommandText = @"INSERT INTO [dbo].[tb_arrendatario] ([TipoId]
                                                                           ,[NumeroId]
                                                                           ,[Nombres]
                                                                           ,[Direccion]
                                                                           ,[Telefono]
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection sqlCon = new SqlConnection(conn))
            {
                ...
                {
                    //here added "@" to write continuous string in new line
                    cmd.CommandText = @"UPDATE [dbo].[tb_arrendatario] SET [TipoId] = @TipoId
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection sqlCon = new SqlConnection(conn))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    cmd.CommandText = "DELETE FROM tb_arrendatario WHERE Codigo=@Codigo";
