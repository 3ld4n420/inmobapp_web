    ...
    public partial class Responsables : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            try
            {
                ...
                string sql = "Select * FROM tb_responsable";
        ...
        protected void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection sqlCon = new SqlConnection(conn))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    //
                    cmd.CommandText = @"INSERT INTO [dbo].[tb_responsable] ([TipoId]
                                                                           ,[NumeroId]
                                                                           ,[Nombres]
                                                                           ,[Direccion]
                                                                           ,[Telefono]
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection sqlCon = new SqlConnection(conn))
            {
                ...
                {
                    //here added "@" to write continuous string in new line
                    cmd.CommandText = @"UPDATE [dbo].[tb_responsable] SET [TipoId] = @TipoId
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection sqlCon = new SqlConnection(conn))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    cmd.CommandText = "DELETE FROM tb_responsable WHERE Codigo=@Codigo";
